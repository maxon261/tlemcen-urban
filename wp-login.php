...
background-image:url(/wp-content/uploads/2021/10/800px-Le_mausolee_de_Sidi_Boumediene_tlemcen_3.jpg);
...
<style type="text/css" id="clc-logo-style">.login.clc-both-logo h1 a{width:100%;height:100%;text-indent: unset;background-position:top center !important;padding-top:30px; background-size: 20px 20px; margin-top: -15px; position:relative;background-image:url(/wp-admin/images/wordpress-logo.svg)}</style>
...
<div class="ml-form-container">	<div id="login">
		<h1><a>Meber Only Social Network</a></h1>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Aller sur Urban Tlemcen</a>		</p>
			</div>
	</div>
</div>
